...
ExAd_HACKING_MAX_TIME = 900;					//SCALAR - Time to complete a hack

ExAd_HACKING_MAX_DISTANCE = 20;					//SCALAR - Maximum distance away from the object being hack players for the hack to proceed. 
...
ExAd_HACKING_FAILED_HACK = 0.25;				//SCALAR - 0-1 The possability for the hack to fail once finished.
