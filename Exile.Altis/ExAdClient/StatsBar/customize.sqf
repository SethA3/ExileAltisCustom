...
ExAd_SB_Show_Bank_Default = true;						//BOOLEAN - Template, show pop tabs in locker
ExAd_SB_Show_Respect_Default = true;					//BOOLEAN - Template, show respect
...
ExAd_SB_Show_Temp_Default = false;						//BOOLEAN - Template, show body temperature
