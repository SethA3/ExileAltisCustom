...
CHVD_maxView = 2200; 		//0-12000

CHVD_maxObj = 2200; 		//0-12000
...
[] spawn {
	...
	CHVD_maxView = if (isNil "CHVD_maxView") then {2200} else {CHVD_maxView};
	CHVD_maxObj = if (isNil "CHVD_maxObj") then {2200} else {CHVD_maxObj};
