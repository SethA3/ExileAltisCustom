...
RibbonGamingDefaultActionFunction = {
...
if ((ExileClientCurrentTrader in ["Exile_Trader_CommunityCustoms2","Exile_Trader_CommunityCustoms3"]) && !(player getVariable["isVIP",false])) then
{
	systemChat "You must be a VIP Member to use this Trader!";
	systemChat "Visit www.ribbongaming.com";
	true
}
else
{
	[] call RibbonGamingDefaultActionFunction;
};