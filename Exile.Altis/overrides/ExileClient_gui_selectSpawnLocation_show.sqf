...
private["_display","_spawnButton","_listBox","_listItemIndex","_numberOfSpawnPoints","_randNum","_randData","_randomSpawnIndex","_spawnMarker"];
...
_spawnMarker = missionNamespace getVariable [format["spawnBeacon_%1",getPlayerUID player],""];
if (_spawnMarker != "") then
{
	_listItemIndex = _listBox lbAdd "Spawn Beacon";
	_listBox lbSetData [_listItemIndex, _spawnMarker];
};
