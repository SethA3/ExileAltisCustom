...
private["_isVIP","_discountRate","_vehicleClass","_dialog","_traderObject","_vehicleConfig","_salesPrice","_pin","_quality","_requiredRespect","_purchaseButton","_armor","_fuelCapacity","_maximumLoad","_maximumSpeed","_stats","_controlID"];
...
_isVIP = player getVariable["isVIP",false];
